...
import { Calendar, Settings, AlertCircle, UserCog, Sparkles, RefreshCw } from 'lucide-react';
...
export default function EmployeeDashboard() {
  ...
  const overdueProjects = projects.filter(
    p => new Date() > p.deadline && p.status !== 'completed'
  ).length;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-6 sm:py-8 md:py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8 relative z-10">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <button
              ...
              className="ml-auto p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-all duration-200"
        ...
        <div className="space-y-4 sm:space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link
              ...
              className="modern-card p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group"
            >
              <UserCog className="h-8 w-8 text-purple-600 mb-3 mx-auto" />
              <h3 className="font-semibold text-gray-900 text-center mb-1">
                Profile Settings
              </h3>
              <p className="text-sm text-gray-500 text-center">
            ...
            <Link
              ...
              className="modern-card p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group"
            >
              <Settings className="h-8 w-8 text-gray-600 mb-3 mx-auto" />
              <h3 className="font-semibold text-gray-900 text-center mb-1">
                View Profile
              </h3>
              <p className="text-sm text-gray-500 text-center">
            ...
            <button
              ...
              className="modern-card p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group"
            >
              <RefreshCw className="h-8 w-8 text-green-600 mb-3 mx-auto" />
              <h3 className="font-semibold text-gray-900 text-center mb-1">
                Refresh Data
              </h3>
              <p className="text-sm text-gray-500 text-center">
