...
import { User, Calendar, MapPin, Briefcase, CreditCard as Edit3 } from 'lucide-react';
...
export default function ProfileCard() {
  ...
  return (
    <div className="modern-card p-4 sm:p-6 group hover:shadow-2xl transition-all duration-300">
      ...
      <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-6">
        ...
        <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center shadow-lg border border-blue-200">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        ...
        <div className="flex space-x-3">
          ...
          <Link
            to="/employee-profile?tab=edit"
            className="flex-1 text-center py-2 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 border border-blue-700"
          >
            Edit Profile
          </Link>
          ...
          <Link
            ...
            className="flex-1 text-center py-2 px-4 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 border border-gray-300"
          >
            Manage Skills
          </Link>
